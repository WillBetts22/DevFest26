...
import { transformRequestBody } from "./lib/case-conversion.mjs";
const environments = {
...
export class Dedalus {
     ...
     */
    constructor({ baseURL = readEnv('DEDALUS_BASE_URL'), apiKey = readEnv('DEDALUS_API_KEY') ?? null, xAPIKey = readEnv('DEDALUS_X_API_KEY') ?? null, organization = readEnv('DEDALUS_ORG_ID') ?? null, provider = readEnv('DEDALUS_PROVIDER') ?? null, providerKey = readEnv('DEDALUS_PROVIDER_KEY') ?? null, providerModel = readEnv('DEDALUS_PROVIDER_MODEL') ?? null, ...opts } = {}) {
        ...
        __classPrivateFieldSet(this, _Dedalus_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!__classPrivateFieldGet(this, _Dedalus_instances, "m", _Dedalus_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return __classPrivateFieldGet(this, _Dedalus_encoder, "f").call(this, { body, headers });
        }
    }
}
