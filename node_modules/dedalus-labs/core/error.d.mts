export declare class DedalusError extends Error {
}
export declare class APIError<TStatus extends number | undefined = number | undefined, THeaders extends Headers | undefined = Headers | undefined, TError extends Object | undefined = Object | undefined> extends DedalusError {
...
export { LengthFinishReasonError, ContentFilterFinishReasonError } from "../lib/parser.mjs";
