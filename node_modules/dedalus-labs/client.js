...
var _Dedalus_instances, _a, _Dedalus_encoder, _Dedalus_baseURLOverridden;
Object.defineProperty(exports, "__esModule", { value: true });
exports.Dedalus = void 0;
...
const case_conversion_1 = require("./lib/case-conversion.js");
const environments = {
...
class Dedalus {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('DEDALUS_BASE_URL'), apiKey = (0, env_1.readEnv)('DEDALUS_API_KEY') ?? null, xAPIKey = (0, env_1.readEnv)('DEDALUS_X_API_KEY') ?? null, organization = (0, env_1.readEnv)('DEDALUS_ORG_ID') ?? null, provider = (0, env_1.readEnv)('DEDALUS_PROVIDER') ?? null, providerKey = (0, env_1.readEnv)('DEDALUS_PROVIDER_KEY') ?? null, providerModel = (0, env_1.readEnv)('DEDALUS_PROVIDER_MODEL') ?? null, ...opts } = {}) {
        _Dedalus_instances.add(this);
        _Dedalus_encoder.set(this, void 0);
        ...
        if (baseURL && opts.environment) {
            throw new Errors.DedalusError('Ambiguous URL; The `baseURL` option (or DEDALUS_BASE_URL env var) and the `environment` option are given. If you want to use the environment you must pass baseURL: null');
        }
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('DEDALUS_LOG'), "process.env['DEDALUS_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Dedalus_encoder, Opts.FallbackEncoder, "f");
    ...
    async authHeaders(opts) {
        return (0, headers_1.buildHeaders)([await this.bearerAuth(opts), await this.apiKeyAuth(opts)]);
    }
    ...
    async apiKeyAuth(opts) {
        ...
        return (0, headers_1.buildHeaders)([{ 'x-api-key': this.xAPIKey }]);
    }
    /**
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new Errors.DedalusError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
    getUserAgent() {
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Dedalus_instances, "m", _Dedalus_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    async prepareOptions(options) {
        if (options.body) {
            options.body = (0, case_conversion_1.transformRequestBody)(options.body);
        }
        if (options.query) {
            options.query = (0, case_conversion_1.transformRequestBody)(options.query);
        }
    }
    /**
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Dedalus_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Dedalus = Dedalus;
_a = Dedalus, _Dedalus_encoder = new WeakMap(), _Dedalus_instances = new WeakSet(), _Dedalus_baseURLOverridden = function _Dedalus_baseURLOverridden() {
    return this.baseURL !== environments[this._options.environment || 'production'];
};
Dedalus.Dedalus = _a;
Dedalus.DEFAULT_TIMEOUT = 60000; // 1 minute
Dedalus.DedalusError = Errors.DedalusError;
Dedalus.APIError = Errors.APIError;
Dedalus.APIConnectionError = Errors.APIConnectionError;
Dedalus.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Dedalus.APIUserAbortError = Errors.APIUserAbortError;
Dedalus.NotFoundError = Errors.NotFoundError;
Dedalus.ConflictError = Errors.ConflictError;
Dedalus.RateLimitError = Errors.RateLimitError;
Dedalus.BadRequestError = Errors.BadRequestError;
Dedalus.AuthenticationError = Errors.AuthenticationError;
Dedalus.InternalServerError = Errors.InternalServerError;
Dedalus.PermissionDeniedError = Errors.PermissionDeniedError;
Dedalus.UnprocessableEntityError = Errors.UnprocessableEntityError;
Dedalus.toFile = Uploads.toFile;
Dedalus.Models = models_1.Models;
Dedalus.Embeddings = embeddings_1.Embeddings;
Dedalus.Audio = audio_1.Audio;
Dedalus.Images = images_1.Images;
Dedalus.Chat = chat_1.Chat;
