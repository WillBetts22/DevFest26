...
export declare namespace DedalusModel {
    /**
     * Optional default generation settings (e.g., temperature, max_tokens) applied
     * when this model is selected.
     */
    interface Settings {
        ...
        response_include?: Array<'file_search_call.results' | 'web_search_call.results' | 'web_search_call.action.sources' | 'message.input_image.image_url' | 'computer_call_output.output.image_url' | 'code_interpreter_call.outputs' | 'reasoning.encrypted_content' | 'message.output_text.logprobs'> | null;
