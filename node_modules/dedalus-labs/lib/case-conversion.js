 ...
 */
const transformKeysDeep = (val, xf) => {
    ...
    if (isPlainObject(val)) {
        ...
        for (const [k, v] of Object.entries(val)) {
            if (k === '__proto__' || k === 'constructor' || k === 'prototype')
                continue;
            const nk = xf(k);
            if (nk === '__proto__' || nk === 'constructor' || nk === 'prototype')
                continue;
 ...
 */
const toSnakeCaseDeep = (v) => transformKeysDeep(v, toSnake);
/**
 ...
 */
function extractPreservedSchemas(body) {
    const schemas = [];
 ...
 */
function restorePreservedSchemas(converted, schemas) {
